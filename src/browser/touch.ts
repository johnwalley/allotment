...
export namespace EventType {
  export const Tap = "-allotment-gesturetap";
  export const Change = "-allotment-gesturechange";
  export const Start = "-allotment-gesturestart";
  export const End = "-allotment-gesturesend";
  export const Contextmenu = "-allotment-gesturecontextmenu";
}
...
export class Gesture implements Disposable {
  ...
  public static addTarget(element: HTMLElement): Disposable {
    if (!Gesture.isTouchDevice()) {
      return Object.freeze<Disposable>({ dispose() {} });
    }
  ...
  public static ignoreTarget(element: HTMLElement): Disposable {
    if (!Gesture.isTouchDevice()) {
      return Object.freeze<Disposable>({ dispose() {} });
    }
